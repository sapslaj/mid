...
func TestFile_buildFileCopyPlan(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"source file asset": {
			...
			expect: FileCopyPlan{
				...
				Hash:      "9843a663aafacdf6eaee226aa8b1028e126064fb5baa39c1d95c42c78839ca0b",
				Unarchive: false,
		...
		"source dir": {
			...
			expect: FileCopyPlan{
				...
				Hash:      "9d72c7c84f577d7aa50402885f7ab449cc76c468c4fbad84e84edb83c4942675",
				Unarchive: true,
		...
		"source tar.gz archive": {
			...
			expect: FileCopyPlan{
				Strategy:  FileCopyPlanFileArchive,
				Hash:      "82e23725fab3676c6f39b7bd8b113de725bc986e3a2dd806886d07f8cce29787",
				Unarchive: true,
		...
		"source zip archive": {
			...
			expect: FileCopyPlan{
				Strategy:  FileCopyPlanFileArchive,
				Hash:      "aa86ef4cd61f1523ea3d58544fbc3dca6a3e4ae4177cdd330f6afebea59df968",
				Unarchive: true,
		...
		"source asset archive": {
			...
			expect: FileCopyPlan{
				...
				Hash:      "becd602404f4bdbff3f62d274ea4366d911614586df006702e43103cbcecc5c2",
				Unarchive: true,
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			...
			assert.Equal(t, tc.expect.Hash, got.Hash)
