...
from ansible.module_utils.community_docker._api.api.client import APIClient as Client
...
from ansible.module_utils.community_docker._api.tls import TLSConfig
from ansible.module_utils.community_docker._api.utils.utils import (
    convert_filters,
    parse_repository_tag,
)

from ansible.module_utils.community_docker.util import (  # noqa: F401, pylint: disable=unused-import
    DEFAULT_DOCKER_HOST,
    DEFAULT_TLS,
    DEFAULT_TLS_VERIFY,
            ...
            for line in self._stream_helper(response, decode=True):
                ...
                if line.get("error"):
                    if line.get("errorDetail"):
                        ...
                        self.fail(
                            "Error pulling %s - code: %s message: %s"
                            % (
                                name,
