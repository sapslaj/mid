...
from ansible.module_utils.mh.exceptions import ModuleHelperException as _MHE
from ansible.module_utils.mh.deco import module_fails_on_exception
    ...
    def __init__(self, module=None):
        ...
        if hasattr(self, "debug"):
            msg = (
                ...
                "Please rename the existing attribute to prevent this message from showing.".format(
