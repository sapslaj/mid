...
const (
	DockerImagePullPullAlways     DockerImagePullPull = "always"
	DockerImagePullPullNotPresent DockerImagePullPull = "not_present"
)
...
func DockerImagePullReturnFromRPCResult(r rpc.RPCResult[rpc.AnsibleExecuteResult]) (DockerImagePullReturn, error) {
	return cast.AnyToJSONT[DockerImagePullReturn](r.Result.Result)
}
