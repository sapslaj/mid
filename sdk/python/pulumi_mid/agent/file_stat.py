...
class FileStatResult:
    ...
    def access_time(self) -> Optional[str]:
    ...
    def calculate_checksum(self) -> Optional[bool]:
...
def file_stat(
    calculate_checksum: Optional[bool] = None,
...
def file_stat_output(
    calculate_checksum: Optional[pulumi.Input[Optional[bool]]] = None,
    follow_symlinks: Optional[pulumi.Input[Optional[bool]]] = None,
