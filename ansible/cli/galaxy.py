...
class GalaxyCLI(CLI):
    ...
    def add_init_options(self, parser, parents=None):
        ...
        init_parser = parser.add_parser(
            "init",
            parents=parents,
            help="Initialize new {0} with the base structure of a {0}.".format(
                galaxy_type
            ),
        )
        ...
        init_parser.add_argument(
            ...
            default=C.GALAXY_COLLECTION_SKELETON
    ...
    def add_install_options(self, parser, parents=None):
        ...
        if galaxy_type == "collection":
            ...
            args_kwargs["help"] = (
                "Role name, URL or tar file. This is mutually exclusive with -r."
            )
            ignore_errors_help = (
        ...
        if self._implicit_role:
            ...
            description_text = (
                ...
                "unless overridden by --{0}s-path.".format(
                    galaxy_type, galaxy_type.upper()
                )
            )
        install_parser = parser.add_parser(
            "install",
            parents=parents,
            help="Install {0}(s) from file(s), URL(s) or Ansible Galaxy".format(
                galaxy_type
            ),
        ...
        install_exclusive.add_argument(
            ...
            action="store_true",
            default=False,
            help="Force overwriting an existing {0} and its dependencies.".format(
                galaxy_type
            ),
        )
    ...
    def run(self):
        ...
        for server_priority, server_key in enumerate(server_list, start=1):
            ...
            server_options = C.config.get_plugin_options(
                plugin_type="galaxy_server", name=server_key
            )
