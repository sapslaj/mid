    ...
    if be.state == "absent":
        ...
        if be.exists():
            if not be.is_mounted():
                ...
                if rc != 0:
                    module.fail_json(
                        msg='Error while destroying BE: "%s"' % err,
                        name=be.name,
                        stderr=err,
                        rc=rc,
                    )
        ...
        if not be.exists():
            ...
            if rc != 0:
                module.fail_json(
                    msg='Error while creating BE: "%s"' % err,
                    name=be.name,
                    stderr=err,
                    rc=rc,
                )
        ...
        if not be.is_activated():
            ...
            if rc != 0:
                module.fail_json(
                    msg='Error while activating BE: "%s"' % err,
                    name=be.name,
                    stderr=err,
                    rc=rc,
                )
        ...
        if not be.is_mounted():
            ...
            if rc != 0:
                module.fail_json(
                    msg='Error while mounting BE: "%s"' % err,
                    name=be.name,
                    stderr=err,
                    rc=rc,
                )
        ...
        if be.is_mounted():
            ...
            if rc != 0:
                module.fail_json(
                    msg='Error while unmounting BE: "%s"' % err,
                    name=be.name,
                    stderr=err,
                    rc=rc,
                )
