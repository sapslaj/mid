...
// Retrieve information on docker stacks tasks using the `docker stack` command
...
func DockerStackTaskInfoReturnFromRPCResult(r rpc.RPCResult[rpc.AnsibleExecuteResult]) (DockerStackTaskInfoReturn, error) {
	return cast.AnyToJSONT[DockerStackTaskInfoReturn](r.Result.Result)
}
