...
// Source: github.com/sapslaj/mid/pkg/providerfw/infer/tests (interfaces: TestConfig,TestResource,TestFunction,TestComponent,TestHost)
//
// Generated by this command:
//
//	mockgen -typed -package tests -destination mocks.gen.go -write_generate_directive -imports goprovider=github.com/sapslaj/mid/pkg/providerfw,pprovider=github.com/pulumi/pulumi/sdk/v3/go/pulumi/provider . TestConfig,TestResource,TestFunction,TestComponent,TestHost
//
...
//go:generate mockgen -typed -package tests -destination mocks.gen.go -write_generate_directive -imports goprovider=github.com/sapslaj/mid/pkg/providerfw,pprovider=github.com/pulumi/pulumi/sdk/v3/go/pulumi/provider . TestConfig,TestResource,TestFunction,TestComponent,TestHost
