...
class ExecArgs:
    def __init__(
        ...
        *,
        ...
        expand_argument_vars: Optional[pulumi.Input[bool]] = None,
    ...
    def expand_argument_vars(self) -> Optional[pulumi.Input[bool]]:
        return pulumi.get(self, "expand_argument_vars")

    @expand_argument_vars.setter
    def expand_argument_vars(self, value: Optional[pulumi.Input[bool]]):
...
class Exec(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deleteBeforeReplace")
    def delete_before_replace(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "delete_before_replace")
    ...
    @property
    @pulumi.getter(name="expandArgumentVars")
    def expand_argument_vars(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "expand_argument_vars")
