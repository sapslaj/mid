...
// volume to be lost!` The volume will be deleted and a new volume with the same
...
const (
	DockerVolumeRecreateAlways         DockerVolumeRecreate = "always"
	DockerVolumeRecreateNever          DockerVolumeRecreate = "never"
	DockerVolumeRecreateOptionsChanged DockerVolumeRecreate = "options-changed"
)
...
const (
	DockerVolumeStateAbsent  DockerVolumeState = "absent"
	DockerVolumeStatePresent DockerVolumeState = "present"
)
...
func DockerVolumeReturnFromRPCResult(r rpc.RPCResult[rpc.AnsibleExecuteResult]) (DockerVolumeReturn, error) {
	return cast.AnyToJSONT[DockerVolumeReturn](r.Result.Result)
}
