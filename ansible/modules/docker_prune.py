...
from ansible.module_utils.community_docker._api.utils.utils import convert_filters
    ...
    if client.module.params.get("builder_cache_keep_storage") is not None:
        try:
            ...
            client.module.fail_json(
                msg="Error while parsing value of builder_cache_keep_storage: {0}".format(
                    exc
                )
            )
