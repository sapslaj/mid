...
class AnsibleTaskListArgsTaskArgs:
    ...
    @property
    @pulumi.getter
    def module(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "module")

    @module.setter
    def module(self, value: pulumi.Input[builtins.str]):
