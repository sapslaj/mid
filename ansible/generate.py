...
def process_module_file(module_file: str):
    ...
    with open(
        ...
        f.write("}\n\n")
        f.write(
            f"func (p *{pascalcase_name}Parameters) ToRPCCall() (rpc.RPCCall[rpc.AnsiballZExecuteArgs], error) {'{'}\n"
        )
        f.write("\targs, err := rpc.AnyToJSONT[map[string]any](p)\n")
        f.write("\tif err != nil {\n")
        f.write("\t\treturn rpc.RPCCall[rpc.AnsiballZExecuteArgs]{}, err\n")
        f.write("\t}\n")
        f.write("\treturn rpc.RPCCall[rpc.AnsiballZExecuteArgs]{\n")
        f.write("\t\tRPCFunction: rpc.RPCAnsiballZExecute,\n")
        f.write("\t\tArgs: rpc.AnsiballZExecuteArgs{\n")
        f.write(f"\t\t\tZip: {pascalcase_name}Zipfile,\n")
        ...
        f.write("}\n\n")
        f.write(
            f"func {pascalcase_name}ReturnFromRPCResult(r rpc.RPCResult[rpc.AnsiballZExecuteResult]) ({pascalcase_name}Return, error) {'{'}\n"
        )
