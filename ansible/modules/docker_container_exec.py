...
from ansible.module_utils.community_docker.selectors import selectors

from ansible.module_utils.community_docker.socket_handler import (
...
from ansible.module_utils.community_docker._api.utils.utils import format_environment
...
def main():
    ...
    try:
        ...
        if e.response is not None and e.response.status_code == 409:
            client.fail(
                'The container "{0}" has been paused ({1})'.format(
