        ...
        if network_os:
            ...
            if network_os in connection_map:
                ...
                raise AnsibleActionFail(
                    f"No fact modules available and we could not find a fact module for your network OS ({network_os}), "
            ...
            if set(modules).intersection(set(C._ACTION_SETUP)):
                ...
                self._display.warning(
                    "Detected 'setup' module and a network OS is set, the output when running it will reflect 'localhost'"
