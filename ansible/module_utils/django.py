...
from ansible.module_utils.cmd_runner import cmd_runner_fmt
from ansible.module_utils.python_runner import PythonRunner
from ansible.module_utils.module_helper import ModuleHelper
...
_args_menu = dict(
    ...
    database=(
        _django_database_args,
        {"database": cmd_runner_fmt.as_opt_eq_val("--database")},
    ),
...
class _DjangoRunner(PythonRunner):
    def __init__(self, module, arg_formats=None, **kwargs):
        ...
        super(_DjangoRunner, self).__init__(
            module, ["-m", "django"], arg_formats=arg_fmts, **kwargs
        )
    ...
    def __call__(
        ...
        **kwargs,
        ...
        return super(_DjangoRunner, self).__call__(
            args_order,
            output_process,
            ignore_value_none,
            check_mode_skip,
