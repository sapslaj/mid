...
class FileLineArgs:
    def __init__(
        ...
        *,
        ...
        backrefs: Optional[pulumi.Input[bool]] = None,
        backup: Optional[pulumi.Input[bool]] = None,
        create: Optional[pulumi.Input[bool]] = None,
        ensure: Optional[pulumi.Input[str]] = None,
        first_match: Optional[pulumi.Input[bool]] = None,
        insert_after: Optional[pulumi.Input[str]] = None,
        insert_before: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter
    def backrefs(self) -> Optional[pulumi.Input[bool]]:
        return pulumi.get(self, "backrefs")

    @backrefs.setter
    def backrefs(self, value: Optional[pulumi.Input[bool]]):
    ...
    def first_match(self) -> Optional[pulumi.Input[bool]]:
        return pulumi.get(self, "first_match")

    @first_match.setter
    def first_match(self, value: Optional[pulumi.Input[bool]]):
    ...
    def insert_before(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "insert_before")

    @insert_before.setter
    def insert_before(self, value: Optional[pulumi.Input[str]]):
...
class FileLine(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def backrefs(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "backrefs")
    ...
    @property
    @pulumi.getter
    def create(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "create")
    ...
    @property
    @pulumi.getter(name="firstMatch")
    def first_match(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "first_match")

    @property
    @pulumi.getter(name="insertAfter")
    def insert_after(self) -> pulumi.Output[Optional[str]]:
        return pulumi.get(self, "insert_after")

    @property
    @pulumi.getter(name="insertBefore")
    def insert_before(self) -> pulumi.Output[Optional[str]]:
        return pulumi.get(self, "insert_before")
