...
namespace Pulumi.Mid
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Mid.version.txt");
    ...
    internal sealed class MidResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MidResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
