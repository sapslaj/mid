...
class ConnectionArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[builtins.str] private_key: The contents of an SSH key to use for the
               connection. This takes preference over the password if provided.
...
if not MYPY:
    ...
    class ExecCommandArgsDict(TypedDict):
        ...
        """
        stdin: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExecCommandArgs:
    def __init__(
        ...
        *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] command: List of arguments to execute. Under the hood, these are passed to `execve`, bypassing any shell
        :param pulumi.Input[builtins.str] dir: Directory path to chdir to before executing the command. Defaults to the
               default working directory for the SSH user and session, usually the user's
               home.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment: Key-value pairs of environment variables to pass to the process. These are
               merged with any system-wide environment variables.
...
if not MYPY:
    ...
    class ResourceConfigDict(TypedDict):
        check: NotRequired[builtins.bool]
...
class ResourceConfig:
    ...
    @check.setter
    def check(self, value: Optional[builtins.bool]):
...
if not MYPY:
    ...
    class ResourceConfigArgsDict(TypedDict):
        check: NotRequired[pulumi.Input[builtins.bool]]
