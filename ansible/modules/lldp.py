...
def gather_lldp(module):
    ...
    if output:
        ...
        for entry in lldp_entries:
            ...
            if (
                final in current_dict
                and isinstance(current_dict[final], dict)
                and module.params["multivalues"]
            ):
...
def main():
    module_args = dict(multivalues=dict(type="bool", required=False, default=False))
