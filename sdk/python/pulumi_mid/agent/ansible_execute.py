...
class AnsibleExecuteResult:
    ...
    def debug_keep_temp_files(self) -> Optional[bool]:
        return pulumi.get(self, "debug_keep_temp_files")

    @property
    @pulumi.getter(name="debugTempDir")
    def debug_temp_dir(self) -> Optional[str]:
...
def ansible_execute_output(
    ...
    check: Optional[pulumi.Input[Optional[bool]]] = None,
    debug_keep_temp_files: Optional[pulumi.Input[Optional[bool]]] = None,
