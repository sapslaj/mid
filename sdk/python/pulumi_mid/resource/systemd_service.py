...
class SystemdServiceArgs:
    def __init__(
        __self__,
        *,
        daemon_reexec: Optional[pulumi.Input[bool]] = None,
        ...
        no_block: Optional[pulumi.Input[bool]] = None,
    ...
    def daemon_reexec(self) -> Optional[pulumi.Input[bool]]:
        return pulumi.get(self, "daemon_reexec")

    @daemon_reexec.setter
    def daemon_reexec(self, value: Optional[pulumi.Input[bool]]):
    ...
    def no_block(self) -> Optional[pulumi.Input[bool]]:
        return pulumi.get(self, "no_block")

    @no_block.setter
    def no_block(self, value: Optional[pulumi.Input[bool]]):
...
class SystemdService(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="daemonReexec")
    def daemon_reexec(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "daemon_reexec")

    @property
    @pulumi.getter(name="daemonReload")
    def daemon_reload(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "daemon_reload")
    ...
    @property
    @pulumi.getter(name="noBlock")
    def no_block(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "no_block")
