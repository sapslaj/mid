...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        variable_end_string = self._task.args.get(
            "variable_end_string", VARIABLE_END_STRING
        )
        block_start_string = self._task.args.get(
            "block_start_string", BLOCK_START_STRING
        )
        block_end_string = self._task.args.get("block_end_string", BLOCK_END_STRING)
        comment_start_string = self._task.args.get(
            "comment_start_string", COMMENT_START_STRING
        )
        comment_end_string = self._task.args.get(
